...
* 第三四分位數（Q3）：  
  Q3 position: (28+1)*0.0.75 = 21.75 ....資料小到大排序後，取第21組跟第22組數據: $\\;\\;21_{th}=316.0,\\;\\; 22_{th}=318.0$  
  Q3 $=316+(318-316)*0.75= 316 + 1.5 =$ `317.5`  
* 最大值（Max）： 485.0

## b)
<img width="1668" height="837" alt="image" src="https://github.com/user-attachments/assets/d3981575-9ec6-46da-9674-9e144c0aea0e" />  
...
數據中最大值與最小值皆未超出上下界[-150,590]，故 `數據中沒有離群值`  
